...
##	[ -r ~/bash_profile ] && . ~/bash_profile
	...
	export HISTIGNORE="e:l:l :ll:ll :ls:ls :cd:cd :exit:history"
...
if [ -r /etc/bash_completion ]; then
	. /etc/bash_completion 
	## This assimes that the global bash_completion will call ~/.bash_completion.
	## !!! This might not be true for some systems, need to check that ~/.bash_completion was
	##     invoked by /etc/bash_completion
